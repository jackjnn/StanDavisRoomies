  ...
  return (
    <header className="z-10 p-4 sm:p-6 w-full border-b border-stone-300 absolute sticky top-0 bg-white/80 backdrop-blur">
      <nav className="max-w-7xl m-auto flex justify-between items-center">
        <Link href="/">
          <span className="flex items-center font-medium my-2 cursor-pointer"> {/* Use span for styles and add cursor-pointer */}
            <img src="/logo.png" alt="Logo" className="h-8 mr-2" />Stan Davis
          </span>
          {/* <h1 className="font-medium my-2">Stan Davis</h1> */}
        </Link>
        {user && (
